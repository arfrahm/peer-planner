...
def create_event():
    if (request.method == "POST"):
        ...
        db.execute("INSERT INTO events (event_name, event_time,event_place, attire, cost, filters) VALUES(:event_name, :event_time, :location, :attire, :cost, :filter, :comments)", event_name= request.form.get("event_name"),event_time = request.form.get("event_time"),event_place=request.form.get("event_place"),attire = request.form.get("attire"),cost = request.form.get("cost"), filters = request.form.get("filter"))
